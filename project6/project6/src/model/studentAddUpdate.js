...
class AddUpdateStudent extends Component {
    render() {
        if (props.detail !== null && props.tid !== null) {
            newId = "studentDetail-" + props.tid
            title = "Öğrenci Detay Bilgileri"
        } else if (props.tid !== null) {
            newId = "studentUpdate-" + props.tid
            ...
            case "Güncelle":
                {
                    ...
                    const button = this.querySelector('.modal-footer>input')
                    button.addEventListener('click', () => addUpdateButtonAction(this, props.tid))
                    break;
                }
            default:
                break;
        ...
        if (buttonName !== "Ekle") {
            fetchAsync(`http://localhost:8000/students/${props.tid}`, 'GET', null)
                .then(async (response) => {
        ...
        return (<div class="modal fade" id={props.newId} tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        {props.buttonName} === "" <input type="submit" value={props.buttonName} class="btn btn-primary" />
                    </div>
                </div>
            </div>
        </div>);
