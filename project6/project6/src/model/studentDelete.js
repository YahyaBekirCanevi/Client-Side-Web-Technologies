...
export default function DeleteStudent({ tid, firstname, lastname }) {
    ...
    return <>
        <Button onClick={() => setShow(true)} type="button" data-toggle="modal" data-target={`#`} variant="danger">Sil</Button>
